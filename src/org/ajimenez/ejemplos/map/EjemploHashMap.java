...
public class EjemploHashMap {
    public static void main(String[] args) {
        ...
        /* el hasMap esta basado en ese algoritmo tanto para buscar objetos, determinar
         si existen, los métodos "contains" o el "get" se basan en el equals y el hascode
         el hashMap busca con el hascode, esta es una forma de obtener valores
         en especifico a traves de llaves o si son únicos entre las llaves ya que
        ...
        // métodos más importantes del hashMap
        // String apellidPaterno = persona.remove("apellidoPaterno");
        ...
        // se pueden iterar los valores con for, foreach, while o iterator
